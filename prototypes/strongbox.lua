...
strongbox_base.icon = "__privat_hextorio__/graphics/icons/strongbox.png"
strongbox_base.picture.layers[1].filename = "__privat_hextorio__/graphics/entity/strongbox/strongbox.png"
